...
std::string to_string(const tuix::Field *f) {
  ...
  default:
    throw std::runtime_error(std::string("to_string(tuix::Field): Unknown field type ") +
                             std::to_string(f->value_type()));
  }
}

std::string to_string(const tuix::BooleanField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::IntegerField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::LongField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::FloatField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::DoubleField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::StringField *f) {
  return std::string(f->value()->begin(), f->value()->end());
}

std::string to_string(const tuix::DateField *f) { return to_string(Date(f->value())); }
...
std::string to_string(const tuix::ShortField *f) { return std::to_string(f->value()); }

std::string to_string(const tuix::TimestampField *f) {
  // TODO: Support fractional seconds to mimic the behavior of
...
void print(const tuix::Field *field) { ocall_print_string(to_string(field).c_str()); }
...
flatbuffers_copy(const tuix::Row *row, flatbuffers::FlatBufferBuilder &builder, bool force_null) {
  ...
  for (flatbuffers::uoffset_t i = 0; i < num_fields; i++) {
    field_values[i] =
        flatbuffers_copy<tuix::Field>(row->field_values()->Get(i), builder, force_null);
  }
...
flatbuffers::Offset<tuix::Field> flatbuffers_copy(const tuix::Field *field,
  ...
  case tuix::FieldUnion_BooleanField:
    return tuix::CreateField(
        ...
        tuix::CreateBooleanField(builder,
                                 static_cast<const tuix::BooleanField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_IntegerField:
    return tuix::CreateField(
        builder, tuix::FieldUnion_IntegerField,
        tuix::CreateIntegerField(builder,
                                 static_cast<const tuix::IntegerField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_LongField:
    return tuix::CreateField(
        builder, tuix::FieldUnion_LongField,
        tuix::CreateLongField(builder,
                              static_cast<const tuix::LongField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_FloatField:
    return tuix::CreateField(
        builder, tuix::FieldUnion_FloatField,
        tuix::CreateFloatField(builder,
                               static_cast<const tuix::FloatField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_DoubleField:
    return tuix::CreateField(
        builder, tuix::FieldUnion_DoubleField,
        tuix::CreateDoubleField(builder,
                                static_cast<const tuix::DoubleField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_StringField: {
    ...
    return tuix::CreateField(
        ...
        tuix::CreateStringFieldDirect(builder, &string_data, string_field->length()).Union(),
        is_null);
  }
  case tuix::FieldUnion_DateField:
    return tuix::CreateField(
        builder, tuix::FieldUnion_DateField,
        tuix::CreateDateField(builder,
                              static_cast<const tuix::DateField *>(field->value())->value())
            .Union(),
        is_null);
  case tuix::FieldUnion_CalendarIntervalField: {
    ...
    return tuix::CreateField(
        ...
        tuix::CreateCalendarIntervalField(builder, cif->months(), cif->microseconds()).Union(),
        is_null);
  }
  case tuix::FieldUnion_ArrayField: {
    ...
    return tuix::CreateField(builder, tuix::FieldUnion_ArrayField,
                             tuix::CreateArrayFieldDirect(builder, &copied_fields).Union(),
                             is_null);
  }
  case tuix::FieldUnion_MapField: {
    ...
    return tuix::CreateField(
        builder, tuix::FieldUnion_MapField,
        tuix::CreateMapFieldDirect(builder, &copied_key_fields, &copied_value_fields).Union(),
        is_null);
  }
  default:
    throw std::runtime_error(std::string("flatbuffers_copy tuix::Field: Unknown field type ") +
