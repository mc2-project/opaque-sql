...
extern "C" {
  ...
  JNIEXPORT void JNICALL Java_edu_berkeley_cs_amplab_opaque_execution_SGXEnclave_Test(
    JNIEnv *, jobject, jlong);

  JNIEXPORT jbyteArray JNICALL Java_edu_berkeley_cs_amplab_opaque_execution_SGXEnclave_ObliviousSort(
  ...
  JNIEXPORT jint JNICALL Java_edu_berkeley_cs_amplab_opaque_execution_SGXEnclave_CountNumRows(
    JNIEnv *, jobject, jlong, jbyteArray);
