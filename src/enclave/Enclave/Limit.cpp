...
void count_rows_per_partition(uint8_t *input_rows, size_t input_rows_length,
  ...
  w.append(output);
  w.output_buffer(output_rows, output_rows_length, "countRowsPerPartition");
}
...
void compute_num_rows_per_partition(uint32_t limit,
  ...
  w.output_buffer(output_rows, output_rows_length, "computeNumRowsPerPartition");
}
...
void limit_return_rows(uint32_t limit,
  ...
  w.output_buffer(output_rows, output_rows_length, "limitReturnRows");
}
