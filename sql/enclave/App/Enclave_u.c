...
sgx_status_t ecall_encrypt_attribute(sgx_enclave_id_t eid, uint8_t* input, uint32_t input_size, uint8_t* output, uint32_t output_size, uint32_t* actual_size)
{
	sgx_status_t status;
	ms_ecall_encrypt_attribute_t ms;
	ms.ms_input = input;
